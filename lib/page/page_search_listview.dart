...
class _PageSearchListviewState extends State<PageSearchListview> {
  ...
  List<Map<String, dynamic>> books = [
    ...
    {"id": 5, "title": "Deep Work", "author": "Call New Port", "year": "2016"},
  ];
          ...
          children: [
            ...
            Expanded(
              child: filteredBooks.isEmpty
                  ? Center(child: Text("Books Not Found"))
                  : isGrid
                  ? buildGridView()
                  : buildListView(),
            ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 6),
                Text(book['author'], style: TextStyle(color: Colors.green)),
                Spacer(),
                Text(book['year'], style: TextStyle(fontSize: 12)),
              ],
            ),
          ),
        );
